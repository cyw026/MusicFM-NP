package com.hr.musicfm.settings;
...
public class SettingsFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void initKeys() {
        DOWNLOAD_PATH_PREFERENCE = getString(com.hr.musicfm.R.string.download_path_key);
        DOWNLOAD_PATH_AUDIO_PREFERENCE = getString(R.string.download_path_audio_key);
        THEME = getString(com.hr.musicfm.R.string.theme_key);
        USE_TOR_KEY = getString(com.hr.musicfm.R.string.use_tor_key);
    }
