...
import com.hr.musicfm.ActivityCommunicator;
...
import com.hr.musicfm.Downloader;
...
public class ErrorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        errorView = (TextView) findViewById(com.hr.musicfm.R.id.errorView);
        ...
        if(errorInfo.message != 0) {
            ...
            findViewById(com.hr.musicfm.R.id.messageWhatHappenedView).setVisibility(View.GONE);
        }
