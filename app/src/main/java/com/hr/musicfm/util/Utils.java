...
public class Utils {
    ...
    public static int getDefaultResolution(Context context, List<VideoStream> videoStreams) {
        ...
        String defaultResolution = defaultPreferences
                .getString(context.getString(com.hr.musicfm.R.string.default_resolution_key), context.getString(R.string.default_resolution_value));
    ...
    public static int getPreferredAudioFormat(Context context, List<AudioStream> audioStreams) {
        ...
        String preferredFormatString = sharedPreferences.getString(context.getString(com.hr.musicfm.R.string.default_audio_format_key), "webm");
    ...
    public static ArrayList<VideoStream> getSortedStreamVideosList(Context context, List<VideoStream> videoStreams, List<VideoStream> videoOnlyStreams, boolean ascendingOrder) {
        ...
        String preferredFormatString = PreferenceManager.getDefaultSharedPreferences(context).getString(context.getString(R.string.preferred_video_format_key), context.getString(com.hr.musicfm.R.string.preferred_video_format_default));
