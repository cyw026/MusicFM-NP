...
import com.hr.musicfm.BuildConfig;
...
public class PopupVideoPlayer extends Service {
    ...
    private void initPopup() {
        ...
        View rootView = View.inflate(this, com.hr.musicfm.R.layout.player_popup, null);
        playerImpl.setup(rootView);

        updateScreenSize();

        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        boolean popupRememberSizeAndPos = sharedPreferences.getBoolean(getString(com.hr.musicfm.R.string.popup_remember_size_pos_key), true);
    ...
    private NotificationCompat.Builder createNotification() {
        notRemoteView = new RemoteViews(BuildConfig.APPLICATION_ID, com.hr.musicfm.R.layout.player_popup_notification);

        if (playerImpl.getVideoThumbnail() == null) notRemoteView.setImageViewResource(com.hr.musicfm.R.id.notificationCover, com.hr.musicfm.R.drawable.dummy_thumbnail);
        else notRemoteView.setImageViewBitmap(R.id.notificationCover, playerImpl.getVideoThumbnail());

        notRemoteView.setTextViewText(R.id.notificationSongName, playerImpl.getVideoTitle());
        notRemoteView.setTextViewText(com.hr.musicfm.R.id.notificationArtist, playerImpl.getChannelName());

        notRemoteView.setOnClickPendingIntent(com.hr.musicfm.R.id.notificationPlayPause,
                PendingIntent.getBroadcast(this, NOTIFICATION_ID, new Intent(ACTION_PLAY_PAUSE), PendingIntent.FLAG_UPDATE_CURRENT));
        notRemoteView.setOnClickPendingIntent(R.id.notificationStop,
                PendingIntent.getBroadcast(this, NOTIFICATION_ID, new Intent(ACTION_CLOSE), PendingIntent.FLAG_UPDATE_CURRENT));
        notRemoteView.setOnClickPendingIntent(com.hr.musicfm.R.id.notificationContent,
        ...
        switch (playerImpl.getCurrentRepeatMode()) {
            case REPEAT_DISABLED:
                notRemoteView.setInt(com.hr.musicfm.R.id.notificationRepeat, setAlphaMethodName, 77);
                break;
            case REPEAT_ONE:
                notRemoteView.setInt(com.hr.musicfm.R.id.notificationRepeat, setAlphaMethodName, 255);
                break;
            case REPEAT_ALL:
                // Waiting :)
                break;
        ...
        return new NotificationCompat.Builder(this, getString(com.hr.musicfm.R.string.notification_channel_id))
                .setOngoing(true)
    ...
    private void updateScreenSize() {
        ...
        popupWidth = getResources().getDimension(com.hr.musicfm.R.dimen.popup_default_width);
    ...
    private class VideoPlayerImpl extends VideoPlayer {
        ...
        public void destroy() {
            super.destroy();
            if (notRemoteView != null) notRemoteView.setImageViewBitmap(com.hr.musicfm.R.id.notificationCover, null);
        }
        ...
        public void onThumbnailReceived(Bitmap thumbnail) {
            ...
            if (thumbnail != null) {
                if (notRemoteView != null) notRemoteView.setImageViewBitmap(com.hr.musicfm.R.id.notificationCover, thumbnail);
        ...
        public void onPlaying() {
            super.onPlaying();
            updateNotification(com.hr.musicfm.R.drawable.ic_pause_white);
        }

        @Override
        public void onBuffering() {
            super.onBuffering();
            updateNotification(com.hr.musicfm.R.drawable.ic_play_arrow_white);
        }
